...
#define KERNAL_TIMER_INTERNAL_MEMORY_SIZE                                                                                                  \
    (sizeof(timer_context_t) * (THREAD_INSTANCE_SUPPORTED_NUMBER + KERNAL_APPLICATION_THREAD_INSTANCE))
#define KERNAL_TIMER_MEMORY_SIZE (sizeof(timer_context_t) * TIMER_INSTANCE_SUPPORTED_NUMBER)
#define KERNAL_SEMAPHORE_MEMORY_SIZE                                                                                                       \
    (sizeof(semaphore_context_t) * (SEMAPHORE_INSTANCE_SUPPORTED_NUMBER + KERNAL_APPLICATION_SEMAPHORE_INSTANCE))
...
#define KERNAL_POOL_MEMORY_SIZE  (sizeof(pool_context_t) * POOL_INSTANCE_SUPPORTED_NUMBER)
...
#define KERNAL_MEMBER_MAP_8      (KERNAL_MEMBER_MAP_7 + KERNAL_POOL_MEMORY_SIZE)
#define KERNAL_MEMBER_MAP_NUMBER (KERNAL_MEMBER_MAP_8 + 1u)
